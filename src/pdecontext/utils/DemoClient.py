    ...
    def uma_http_request(
        ...
        while repeat and count < 2:
            ...
            if access_token is not None:
                ...
                self.trace(
                    log_prefix, "No existing access token - making a naive attempt"
                )
            # attempt access
            ...
            # if we got a 401 then initiate the UMA flow
                ...
                self.trace(
                    log_prefix,
                    "Received a 401 (Unauthorized) response to access attempt",
                )
                ...
                if id_token is not None:
                    ...
                    self.trace(
                        log_prefix, "No ID Token, so cannot proceed with UMA flow"
                    )
